    ...
    <div class="card card-widget widget-user shadow">
        ...
        <div class="card-footer">
            <div class="container-fluid">
                <dl>
                    <dt>Address</dt>
                    <dd><?php echo isset($address) ? $address : 'N/A'; ?></dd>
                </dl>
                <dl>
                    <dt>Gender</dt>
                    <dd><?php echo isset($gender) ? $gender : 'N/A'; ?></dd>
                </dl>
                <dl>
                    <dt>Contact</dt>
                    <dd><?php echo isset($contact) ? $contact : 'N/A'; ?></dd>
                </dl>
                <dl>
                    <dt>User Type</dt>
                    <dd><?php echo isset($type) && isset($type_arr[$type]) ? $type_arr[$type] : 'Unknown'; ?></dd>
                </dl>
            </div>
        </div>
    </div>
